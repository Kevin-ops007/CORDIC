...
arm-linux-gcc -O1 cordic_timing.c cordic_V_standard.c -o cordic_O1.exe
arm-linux-gcc -O2 cordic_timing.c cordic_V_standard.c -o cordic_O2.exe
...
for c_file in "${c_files[@]}"; do
    ...
    if [[ $c_file == "cordic_V_32bit.c" ]]; then
        ...
        arm-linux-gcc -O3 "$main_file" "$c_file" -o "$output_executable"
        arm-linux-gcc -O3 -S "$c_file" -o "$arm_code"
