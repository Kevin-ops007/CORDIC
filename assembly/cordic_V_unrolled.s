...
cordic_V_fixed_point:
	...
	rsble	r4, r3, r4
	addgt	r4, r4, r3
	suble	r2, ip, r2, asr #7
	addgt	r2, ip, r2, asr #7
	cmp	r1, #0
	ldrgt	r3, [r0, #32]
	ldrle	r3, [r0, #32]
	subgt	ip, r1, r2, asr #8
	addle	ip, r1, r2, asr #8
	addgt	r4, r4, r3
	rsble	r4, r3, r4
	addgt	r2, r2, r1, asr #8
	suble	r2, r2, r1, asr #8
	cmp	ip, #0
	ldrgt	r3, [r0, #36]
	ldrle	r3, [r0, #36]
	subgt	r1, ip, r2, asr #9
	addle	r1, ip, r2, asr #9
	addgt	r4, r4, r3
	rsble	r4, r3, r4
